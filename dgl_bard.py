...
def main():
    ...
    social_partition_ids = metis_partition(social_adj_lists, num_parts)
    item_partition_ids = metis_partition(item_adj_lists, num_parts)
    #node_feature
    node_agg = Node_Aggregator(v2e, r2e, u2e, embed_dim, r2e.num_embeddings - 1, social_partition_ids, item_partition_ids, cuda=device)
